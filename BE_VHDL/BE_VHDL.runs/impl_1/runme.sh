...
HD_PWD='D:/INSA_Toulouse/BE_VHDL/BE_VHDL/BE_VHDL.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Illustration1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Illustration1.tcl -notrace
