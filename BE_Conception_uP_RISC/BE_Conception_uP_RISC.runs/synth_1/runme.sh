...
HD_PWD='D:/INSA_Toulouse/BE_VHDL/BE_Conception_uP_RISC/BE_Conception_uP_RISC.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DATA_Flow.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DATA_Flow.tcl
